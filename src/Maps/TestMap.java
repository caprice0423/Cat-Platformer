...
public class TestMap extends Map {
	...
	public ArrayList<Enemy> loadEnemies() {
		...
		enemies.add(new DinosaurEnemy(getPositionByTileIndex(19, 1).addY(2), getPositionByTileIndex(22, 1).addY(2),
				Direction.RIGHT));
		return enemies;
	}
	...
	public ArrayList<EnhancedMapTile> loadEnhancedMapTiles() {
		...
		enhancedMapTiles.add(new HorizontalMovingPlatform(ImageLoader.load("GreenPlatform.png"),
				getPositionByTileIndex(24, 6), getPositionByTileIndex(27, 6), TileType.JUMP_THROUGH_PLATFORM, 3,
